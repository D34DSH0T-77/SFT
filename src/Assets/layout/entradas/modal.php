...
<div class="modal fade" id="modalEntrada" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="background-color: var(--bg-card); color: var(--text-main);">
            <form action="<?= RUTA_BASE . 'Entradas/agregar' ?>" method="POST" id="formEntrada">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="fecha" id="fechaInput" class="form-control" required style="background-color: var(--bg-body); color: var(--text-main); border-color: var(--border-color);">
                        </div>
                        <div class="col-md-4">
                ...
                <div class="modal-footer" style="border-top-color: var(--border-color);">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnGuardar">Guardar Entrada</button>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="modalConfirmacion" tabindex="-1" aria-hidden="true" style="z-index: 1060;">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content" style="background-color: var(--bg-card); color: var(--text-main);">
            <div class="modal-header" style="border-bottom-color: var(--border-color);">
                <h5 class="modal-title">Confirmar Total</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="totalUsdInput" class="form-label">Total Dólares</label>
                    <input type="number" id="totalUsdInput" class="form-control" step="0.01" min="0" required style="background-color: var(--bg-body); color: var(--text-main); border-color: var(--border-color);">
                </div>
            </div>
            <div class="modal-footer" style="border-top-color: var(--border-color);">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Atrás</button>
                <button type="button" class="btn btn-primary" id="btnConfirmarEnvio">Confirmar y Guardar</button>
            </div>
        </div>
    </div>
</div>